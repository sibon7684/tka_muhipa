...
import { generateScores, parseBirthDate, parseClientCSV } from "./utils";
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans antialiased pb-12 selection:bg-blue-500/30 selection:text-white relative overflow-hidden">
      ...
      <header className="max-w-4xl mx-auto px-4 pt-6 pb-2 flex justify-between items-center text-white relative z-10">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 flex items-center justify-center shadow-lg overflow-hidden">
            <img src={schoolLogo} alt="Logo" className="w-8 h-8 object-contain" referrerPolicy="no-referrer" />
          </div>
          <div>
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-[32px] shadow-2xl p-8 border border-white/20 text-center py-16 flex flex-col items-center justify-center text-white max-w-md mx-auto relative overflow-hidden">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img src={schoolLogo} alt="Loading..." className="w-[22px] h-[22px] object-contain animate-pulse" referrerPolicy="no-referrer" />
              </div>
            </div>
              ...
              >
                ...
                <div className="text-center mb-6 text-white pb-2">
                  ...
                  <p className="text-xs text-white/60 mt-3 max-w-xs mx-auto leading-relaxed">
                    Masukkan data diri Anda untuk melihat rincian nilai dan mengunduh sertifikat resmi hasil asesmen SMP Muhammadiyah Pakem.
                  </p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-[32px] shadow-2xl border border-white/20 overflow-hidden transform transition duration-500 text-white">
                  <div className="p-6 sm:p-8">
                    ...
                    {/* Stepper Indicator */}
                    <div className="flex items-center space-x-2 text-[10px] font-bold tracking-widest text-white/40 mb-6 font-mono border-b border-white/10 pb-4">
                      <span className={`${!selectedStudent ? "text-blue-400 font-extrabold" : "text-emerald-400"}`}>1. CARI NAMA</span>
                      <ChevronRight size={12} className="text-white/20" />
                      <span className={`${selectedStudent && !isUnlocked ? "text-blue-400 font-extrabold" : "text-white/20"}`}>2. VERIFIKASI SEED</span>
                      <ChevronRight size={12} className="text-white/20" />
                      <span className="text-white/20">3. HASIL NILAI</span>
                    </div>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    ...
                    >
                      ...
                      <span>DOWNLOAD RESMI (PDF)</span>
                    </button>
                  </div>

                  {/* Header Student Bio Card */}
                  <div className="bg-white/10 backdrop-blur-xl rounded-[32px] shadow-2xl border border-white/20 p-5 md:p-6 overflow-hidden relative text-white">
                    {/* Top Accent Strip */}
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      <div className="flex items-center space-x-4">
                        <div className="bg-white/10 text-white p-3 rounded-2xl flex items-center justify-center border border-white/10">
                      ...
                      <div className="bg-white/5 border border-white/10 rounded-2xl p-3 flex shrink-0 items-center space-x-2.5 text-xs">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white/10 backdrop-blur-xl rounded-[32px] p-6 border border-white/20 shadow-2xl flex flex-col sm:flex-row justify-between items-center gap-4 md:col-span-3 text-white">
                      <div className="space-y-3 text-center sm:text-left">
                        <div>
                          <span className="text-[9px] text-blue-300 font-extrabold tracking-widest uppercase font-mono">
                            SKOR RATA-RATA (TKAD)
                          </span>
                          <h4 className="text-lg font-black text-white mt-0.5 leading-none font-display">Indeks Capaian Total</h4>
                        </div>

                        <div className="flex items-center justify-center sm:justify-start space-x-2 bg-blue-500/10 text-blue-300 py-1.5 px-3 rounded-xl border border-blue-500/20 font-mono text-[10px] font-bold">
                          <Award size={12} className="shrink-0 text-blue-400" />
                          <span>GRADE PRESTASI: {activeScores.grade} (EXCELLENT)</span>
                        </div>
                      </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-xl rounded-[32px] shadow-2xl border border-white/20 p-5 md:p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-end">
                          ...
                          <span className="font-mono text-xs font-bold text-white bg-white/10 px-2 py-0.5 rounded-md border border-white/10">
